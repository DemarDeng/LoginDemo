import { defineComponent, openBlock, createBlock, Transition, mergeProps, toHandlers, withCtx, renderSlot, inject, computed, reactive, ref, getCurrentInstance, watch, provide, onMounted, onBeforeUnmount, h, Fragment, withDirectives, vShow, nextTick, isRef, resolveComponent, createElementBlock, normalizeClass, normalizeStyle, createElementVNode, createTextVNode, toDisplayString } from 'vue';
  ...
  setup(props, { emit, slots, expose }) {
    ...
    return () => {
      ...
      if (props.mode === "horizontal") {
        ...
        if (items2.length === originalSlot.length) {
...
Menu.MenuItem = script$1;
Menu.MenuItemGroup = script;
Menu.SubMenu = script$2;
const _Menu = Menu;
const ElMenu = _Menu;
const ElMenuItem = script$1;
const ElMenuItemGroup = script;
const ElSubMenu = script$2;

export { ElMenu, ElMenuItem, ElMenuItemGroup, ElSubMenu, _Menu as default };
